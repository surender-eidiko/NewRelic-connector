...
/**
 * The Class Application_hosts.
 */
public class Application_hosts {
    ...
    {
        return "ClassPojo [id = "+id+", host = "+host+", application_name = "+application_name+", application_summary = "+application_summary+", links = "+links+", health_status = "+health_status+", language = "+language+"]";
    }
}
